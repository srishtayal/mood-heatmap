...
//   // Initialize User ID on load so the Setup Link works
//   useEffect(() => {
...
//       {/* --- Detailed Setup Modal (Android/MacroDroid Version) --- */}
//       {activeView && (
...
//             {/* Header */}
//             <div className="flex justify-between items-center mb-6 sticky top-0 bg-neutral-900 z-10 py-2 border-b border-neutral-800">
...
//                   Get the Automation App
//                 </h3>
//                 <ul className="list-disc list-outside pl-10 space-y-2 text-neutral-400 text-sm leading-relaxed">
//                   <li>Download <b>MacroDroid</b> from the Google Play Store.</li>
//                   <li>Open it and skip the intro tutorial.</li>
//                 </ul>
//               </div>
...
//                   Copy Your Link
//                 </h3>
//                 <div className="pl-10 space-y-2 text-neutral-400 text-sm leading-relaxed">
//                   <p>This is your personal wallpaper link. Copy it:</p>
//                   <code className="block mt-2 bg-neutral-950 p-4 rounded-lg text-xs text-green-400 break-all select-all border border-neutral-800 font-mono">
//                     {activeView === 'month' 
//                       ? `https://mood-heatmap.netlify.app/api/wallpaper?view=month&user_id=${userId || 'YOUR_ID'}`
//                       : `https://mood-heatmap.netlify.app/api/wallpaper?user_id=${userId || 'YOUR_ID'}`
//                     }
//                   </code>
//                 </div>
//               </div>

//               {/* Phase 3: MacroDroid Setup */}
//               <div className="space-y-3">
//                 <h3 className="text-white font-bold text-lg flex items-center gap-3">
...
//                   <p>Tap <b>"Add Macro"</b> (the big + tile) and add these <b>Actions</b> (Blue):</p>
                  
//                   <div className="bg-black border border-neutral-800 rounded-xl p-4 space-y-4">
                    
//                     {/* Step A: HTTP Request */}
//                     <div className="grid grid-cols-[20px_1fr] gap-2 border-b border-neutral-800 pb-3">
//                       <span className="text-neutral-500 font-mono">A.</span>
//                       <span>
//                         Add <b>HTTP Request</b>.<br/>
//                         <span className="text-neutral-500 text-xs block mt-1">• Method: <b>GET</b></span>
//                         <span className="text-neutral-500 text-xs block">• URL: Paste your link from Step 2.</span>
//                         <span className="text-neutral-500 text-xs block">• Tick: <b>Block next actions</b></span>
//                         <span className="text-neutral-500 text-xs block">• Tick: <b>Save response to file</b></span>
//                         <span className="text-neutral-500 text-xs block">• Path: Select Downloads folder & name it <code>/mood.png</code></span>
//                       </span>
//                     </div>

//                     {/* Step B: Set Wallpaper */}
//                     <div className="grid grid-cols-[20px_1fr] gap-2">
//                       <span className="text-neutral-500 font-mono">B.</span>
//                       <span>
//                         Add <b>Set Wallpaper</b>.<br/>
//                         <span className="text-neutral-500 text-xs block mt-1">• Select Image: Navigate to Downloads and pick <code>mood.png</code>.</span>
//                         <span className="text-neutral-600 italic text-[10px] mt-1">(If file is missing, run the HTTP request once to create it).</span>
//                       </span>
//                     </div>
...
//                 </h3>
//                 <ul className="list-disc list-outside pl-10 space-y-2 text-neutral-400 text-sm leading-relaxed">
//                   <li>Go to the <b>Triggers</b> (Red) tab.</li>
//                   <li>Add <b>Regular Interval</b>.</li>
//                   <li>Set it to <b>Every 1 Hour</b>.</li>
//                   <li>Name your macro "Mood Sync" and save it!</li>
//                 </ul>
//               </div>
...
//             <button 
//               onClick={closeModal}
//               className="w-full bg-white text-black font-bold py-4 rounded-xl hover:bg-neutral-200 transition-colors active:scale-[0.98]"
//             >
//               I've finished setup
//             </button>
//           </div>
